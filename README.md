...
|--------|-------------|------|
| [**serverless-url-shortener**](https://github.com/Mas-HJ/serverless-url-shortener) | Production-shaped URL shortener with multi-account AWS Organizations IaC. Rate-limited, audit-logged, per-action IAM least-privilege, IP-literal/userinfo URL validation. | AWS SAM • Lambda • API Gateway • DynamoDB • TypeScript • React |                                                                                                                     
